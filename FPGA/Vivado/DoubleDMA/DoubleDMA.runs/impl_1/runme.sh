...
HD_PWD='E:/Vivado/Project_Vivado/DoubleDMA/DoubleDMA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DoubleDMA_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DoubleDMA_wrapper.tcl -notrace
