...
HD_PWD='E:/Vivado/Project_Vivado/DoubleDMA/DoubleDMA.runs/DoubleDMA_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DoubleDMA_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DoubleDMA_xbar_0.tcl
