...
HD_PWD='E:/Vivado/Project_Vivado/DoubleDMA/DoubleDMA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DoubleDMA_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DoubleDMA_wrapper.tcl
