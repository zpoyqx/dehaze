...
HD_PWD='E:/Vivado/Project_Vivado/DoubleDMA/DoubleDMA.runs/DoubleDMA_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DoubleDMA_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DoubleDMA_processing_system7_0_0.tcl
