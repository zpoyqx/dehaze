...
HD_PWD='E:/Vivado/Project_Vivado/DoubleDMA/DoubleDMA.runs/DoubleDMA_auto_pc_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DoubleDMA_auto_pc_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DoubleDMA_auto_pc_1.tcl
