; ModuleID = 'E:/Vivado/Project_Vitis_HLS/FinalDehaze/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_FinalDehaze_ir(%"class.hls::stream"* %src, i32* %B_A, i32* %G_A, i32* %R_A, %"class.hls::stream"* %dst) local_unnamed_addr #0 {
entry:
  %src_copy = alloca %"class.hls::stream", align 512
  %B_A_copy = alloca i32, align 512
  %G_A_copy = alloca i32, align 512
  %R_A_copy = alloca i32, align 512
  %dst_copy = alloca %"class.hls::stream", align 512
  call fastcc void @copy_in(%"class.hls::stream"* %src, %"class.hls::stream"* nonnull align 512 %src_copy, i32* %B_A, i32* nonnull align 512 %B_A_copy, i32* %G_A, i32* nonnull align 512 %G_A_copy, i32* %R_A, i32* nonnull align 512 %R_A_copy, %"class.hls::stream"* %dst, %"class.hls::stream"* nonnull align 512 %dst_copy)
  call void @apatb_FinalDehaze_hw(%"class.hls::stream"* %src_copy, i32* %B_A_copy, i32* %G_A_copy, i32* %R_A_copy, %"class.hls::stream"* %dst_copy)
  call fastcc void @copy_out(%"class.hls::stream"* %src, %"class.hls::stream"* nonnull align 512 %src_copy, i32* %B_A, i32* nonnull align 512 %B_A_copy, i32* %G_A, i32* nonnull align 512 %G_A_copy, i32* %R_A, i32* nonnull align 512 %R_A_copy, %"class.hls::stream"* %dst, %"class.hls::stream"* nonnull align 512 %dst_copy)
  ret void
}

; Function Attrs: noinline
define internal fastcc void @copy_in(%"class.hls::stream"*, %"class.hls::stream"* noalias align 512, i32* readonly, i32* noalias align 512, i32* readonly, i32* noalias align 512, i32* readonly, i32* noalias align 512, %"class.hls::stream"*, %"class.hls::stream"* noalias align 512) unnamed_addr #1 {
entry:
...
; Function Attrs: noinline
define internal fastcc void @copy_out(%"class.hls::stream"*, %"class.hls::stream"* noalias align 512, i32*, i32* noalias readonly align 512, i32*, i32* noalias readonly align 512, i32*, i32* noalias readonly align 512, %"class.hls::stream"*, %"class.hls::stream"* noalias align 512) unnamed_addr #6 {
entry:
...
declare void @apatb_FinalDehaze_hw(%"class.hls::stream"*, i32*, i32*, i32*, %"class.hls::stream"*)

define void @FinalDehaze_hw_stub_wrapper(%"class.hls::stream"*, i32*, i32*, i32*, %"class.hls::stream"*) #7 {
entry:
  call void @copy_out(%"class.hls::stream"* null, %"class.hls::stream"* %0, i32* null, i32* %1, i32* null, i32* %2, i32* null, i32* %3, %"class.hls::stream"* null, %"class.hls::stream"* %4)
  call void @FinalDehaze_hw_stub(%"class.hls::stream"* %0, i32* %1, i32* %2, i32* %3, %"class.hls::stream"* %4)
  call void @copy_in(%"class.hls::stream"* null, %"class.hls::stream"* %0, i32* null, i32* %1, i32* null, i32* %2, i32* null, i32* %3, %"class.hls::stream"* null, %"class.hls::stream"* %4)
  ret void
}

declare void @FinalDehaze_hw_stub(%"class.hls::stream"*, i32*, i32*, i32*, %"class.hls::stream"*)
