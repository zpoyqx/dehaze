; ModuleID = 'E:/Vivado/Project_Vitis_HLS/AirLight/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_AirLight_ir(%"class.hls::stream"* %src, i32* %B_A, i32* %G_A, i32* %R_A) local_unnamed_addr #0 {
entry:
  ...
  call fastcc void @copy_in(%"class.hls::stream"* %src, %"class.hls::stream"* nonnull align 512 %src_copy, i32* %B_A, i32* nonnull align 512 %B_A_copy, i32* %G_A, i32* nonnull align 512 %G_A_copy, i32* %R_A, i32* nonnull align 512 %R_A_copy)
  call void @apatb_AirLight_hw(%"class.hls::stream"* %src_copy, i32* %B_A_copy, i32* %G_A_copy, i32* %R_A_copy)
  call fastcc void @copy_out(%"class.hls::stream"* %src, %"class.hls::stream"* nonnull align 512 %src_copy, i32* %B_A, i32* nonnull align 512 %B_A_copy, i32* %G_A, i32* nonnull align 512 %G_A_copy, i32* %R_A, i32* nonnull align 512 %R_A_copy)
  ret void
}

; Function Attrs: noinline
define internal fastcc void @copy_in(%"class.hls::stream"*, %"class.hls::stream"* noalias align 512, i32* readonly, i32* noalias align 512, i32* readonly, i32* noalias align 512, i32* readonly, i32* noalias align 512) unnamed_addr #1 {
entry:
...
; Function Attrs: noinline
define internal fastcc void @copy_out(%"class.hls::stream"*, %"class.hls::stream"* noalias align 512, i32*, i32* noalias readonly align 512, i32*, i32* noalias readonly align 512, i32*, i32* noalias readonly align 512) unnamed_addr #6 {
entry:
...
declare void @apatb_AirLight_hw(%"class.hls::stream"*, i32*, i32*, i32*)

define void @AirLight_hw_stub_wrapper(%"class.hls::stream"*, i32*, i32*, i32*) #7 {
entry:
  call void @copy_out(%"class.hls::stream"* null, %"class.hls::stream"* %0, i32* null, i32* %1, i32* null, i32* %2, i32* null, i32* %3)
  call void @AirLight_hw_stub(%"class.hls::stream"* %0, i32* %1, i32* %2, i32* %3)
  call void @copy_in(%"class.hls::stream"* null, %"class.hls::stream"* %0, i32* null, i32* %1, i32* null, i32* %2, i32* null, i32* %3)
  ret void
}

declare void @AirLight_hw_stub(%"class.hls::stream"*, i32*, i32*, i32*)
